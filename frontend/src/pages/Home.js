...
const Home = () => {
  ...
  return (
    ...
    <form onSubmit={login} className="flex flex-col gap-4 w-64">
      ...
      <input type="number" placeholder="Digite a mesa" className="p-2 text-sm font-semibold rounded-md border-none outline-none" onChange={(e) => setTable(e.target.value)} />
